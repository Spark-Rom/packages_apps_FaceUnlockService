package com.spark.faceunlock.service;
...
import com.spark.faceunlock.AppConstants;
import com.spark.faceunlock.R;
import com.spark.faceunlock.camera.CameraFaceAuthController;
import com.spark.faceunlock.camera.CameraFaceEnrollController;
import com.spark.faceunlock.camera.CameraUtil;
import com.spark.faceunlock.util.NotificationUtils;
...
import com.spark.faceunlock.vendor.VendorFaceManager;
import com.spark.faceunlock.vendor.impl.VendorFaceManagerImpl;

import java.util.Random;

@SuppressWarnings("SynchronizeOnNonFinalField")
public class FaceAuthService extends Service {
    private static final String ALARM_FAIL_TIMEOUT_LOCKOUT = "com.spark.faceunlock.ACTION_LOCKOUT_RESET";
    private static final String ALARM_TIMEOUT_FREEZED = "com.spark.faceunlock.freezedtimeout";
